// 1. Given a string with the value of a day of the week, return the number that that day is in the week. A second argument will be provided to determine if true, start the week on Monday, else Sunday is the start of the week. If the string is not a day of the week but is bad input, then return the string 'That's not a day of the week'.
// Example:
// input: 'Sunday', false
// output: 1
//Example:
...
function daysPosition(day, offset) {
  day = day.toLowerCase();
  //if offset is true what do i wanna do? can handle mathematically
  switch (day) {
    case "monday":
      if (offset) {
        return 1;
...
function golfScore(score, par) {
  let correctedScore = score - par;
  switch (correctedScore) {
    case -3:
      return "Ace";
      break;
    case -2:
